...
export const collections: { users?: mongoDB.Collection; washingMachines?: mongoDB.Collection } = {}
...
export async function connectToDatabase() {
  ...
  console.log(
    `Successfully connected to database: ${db.databaseName} and collections: ${usersCollection.collectionName}, ${washingMachinesCollection.collectionName}`
  )
}
