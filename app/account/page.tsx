  ...
  return (
    <main className={styles.defaultContainer}>
      <div className="mx-auto max-w-lg py-16">
        ...
        <p className="mt-1 text-zinc-600 dark:text-zinc-300">Your profile, signed in through your identity provider.</p>

        <div className="glass-card mt-8 flex items-center gap-5 p-6 sm:p-8">
          {user.image && (
            // A plain <img> tag, since the image can come from any self-hosted identity provider.
